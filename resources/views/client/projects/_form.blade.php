                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="submit-field">
                            ...
                            <x-form.select name="category_id" id="category_id" :options="$categories"
                                :selected="$project->category_id" class="selectpicker with-border" data-size="7"
                    ...
                    <div class="col-xl-12">
                        <div class="submit-field">
                            ...
                            <x-form.textarea name="description" id="description" :value="$project->description"
                                cols="30" rows="5" class="with-border" />
