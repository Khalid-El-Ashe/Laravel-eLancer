                        ...
                        <li>
                            ...
                            <div class="job-listing">
                                ...
                                <div class="job-listing-details">
                                    ...
                                    <div class="job-listing-description">
                                        <h3 class="job-listing-title"><a href="#">{{ $proposal->project->title }}</a>
                                            <span class="dashboard-status-button yellow">{{ $proposal->status }}</span>
                                        </h3>
                            ...
                            <div class="buttons-to-right always-visible">
                                <a href="#" class="button ripple-effect"><i
                                        class="icon-material-outline-supervisor-account"></i> Manage Candidates <span
                                        class="button-info">3</span></a>
                                {{-- <a href="{{ route('freelancer.proposal.edit', $proposal->id) }}"
                                    class="button gray ripple-effect ico" title="Edit" data-tippy-placement="top"><i
                                        class="icon-feather-edit"></i></a> --}}

                                <form action="{{ route('freelancer.proposal.destroy', $proposal->id) }}" method="post">
                                    @csrf
