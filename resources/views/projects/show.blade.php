                            ...
                            <div class="header-details">
                                ...
                                <ul>
                                    <li><a href="single-company-profile.html"><i
                                                class="icon-material-outline-business"></i> King</a></li>
                                    <li>
        ...
        <div class="sign-in-form">
            ...
            <div class="popup-tabs-container">
                ...
                <div class="popup-tab-content" id="tab">
                    ...
                    @endif
                    <!-- Form -->
                    <form method="post" action="{{ route('freelancer.proposal.store', $project->id) }}"
                        id="apply-now-form">
                        @csrf
                        <div class="input-with-icon-left">
                            <i class="icon-material-outline-account-circle"></i>
                            <x-form.textarea class="input-text with-border" name="description" id="description"
                                placeholder="Proppsal" required="required" />
                        </div>

                        <div class="input-with-icon-left">
                            <i class="icon-material-baseline-mail-outline"></i>
                            <x-form.input type="number" class="input-text with-border" name="cost" id="cost"
                                placeholder="Cost" required="required" />
                        </div>

                        <div class="input-with-icon-left">
                            <i class="icon-material-baseline-mail-outline"></i>
                            <x-form.input type="number" class="input-text with-border" name="duration" id="duration"
                                placeholder="Duration" required="required" />
                            <x-form.select class="input-text with-border" name="duration_unit" id="duration_unit"
                                required="required" :options="$units??[]" />
                        </div>
